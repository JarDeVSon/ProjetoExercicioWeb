...
Funcionalidade: Login
  Sendo (quem?)
  Posso (o que?)
  Para que ( beneficio a ser alcançado)
  ...
  Esquema do Cenario: Realizar Login com <identificacao>
    ...
    Exemplos: 
      ...
      | campos obrigatórios | chronos | Senha123 | false    |
  ...
  Esquema do Cenario: Realizar Login com <identificacao>
    ...
    Exemplos: 
      | identificacao        | usuario | senha     | remember |
      | com usuário inválido | chronos1 | Senha123 | false    |
      | com senha inválida   | chronos | 1Senha123 | false    |
  ...
  Esquema do Cenario: Realizar login com <identificacao>
    ...
    Exemplos: 
      | identificacao         | usuario | senha | remember |
      | com usuário em branco |         | senha | false    |
